...
<head>
   ...
   <meta name="keywords" content="Spaceship">
   <meta name="description" content="Website about space">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     ...
                     <p class="banner_text">Prepare for an extraordinary journey aboard our Spaceship. Fasten your seatbelt!</p>
                     <div class="read_bt"><a href="gallery.php">Get Ready!</a></div>
                  </div>
               </div>
               <div class="carousel-item">
                  <div class="container">
                     <h1 class="banner_taital">Selamat Datang</h1>
                     <p class="banner_text">Bersiaplah untuk perjalanan luar biasa di Pesawat Luar Angkasa kami. Kencangkan sabuk pengaman Anda!</p>
                     <div class="read_bt"><a href="gallery.php">Get Ready!</a></div>
                  </div>
               </div>
            </div>
